  ...
  return (
    ...
    >
      <div
        className={cn(
          floating,
          "absolute end-0 bottom-full z-10 mb-2 flex w-60 origin-bottom-right flex-col gap-3.5 rounded-2xl p-4 shadow-[0_12px_32px_-12px_rgba(15,23,42,0.28),0_4px_12px_-6px_rgba(15,23,42,0.16)] dark:shadow-[0_12px_32px_-12px_rgba(0,0,0,0.6),0_4px_12px_-6px_rgba(0,0,0,0.45)]",
          "transition-[opacity,scale] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none",
          "pointer-events-none scale-[0.97] opacity-0",
